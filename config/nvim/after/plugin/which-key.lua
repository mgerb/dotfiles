...
local mappings = {
	...
	a = {
		...
		c = { "<cmd>lua require('mg.custom').jump_to_angular_component_part('ts')<cr>", "Component" },
		j = {
			name = "Jesting",
		...
		m = { "<cmd>lua require('mg.custom').jump_to_nearest_module()<cr>", "Module" },
		s = { "<cmd>lua require('mg.custom').jump_to_angular_component_part('scss')<cr>", "SCSS" },
		S = { "<cmd>lua require('mg.custom').jump_to_angular_component_part('spec%.ts')<cr>", "Test" },
		t = { "<cmd>lua require('mg.custom').jump_to_angular_component_part('html')<cr>", "HTML" },
		xr = { "<cmd>lua require('mg.custom').jump_to_ngrx_parts('reducer')<cr>", "NGRX Reducer" },
		xe = { "<cmd>lua require('mg.custom').jump_to_ngrx_parts('effects')<cr>", "NGRX Effects" },
		xa = { "<cmd>lua require('mg.custom').jump_to_ngrx_parts('actions')<cr>", "NGRX Actions" },
		xf = { "<cmd>lua require('mg.custom').jump_to_ngrx_parts('facade')<cr>", "NGRX Facade" },
		xs = { "<cmd>lua require('mg.custom').jump_to_ngrx_parts('selectors')<cr>", "NGRX Selectors" },
		g = {
			name = "Generate",
			c = {
